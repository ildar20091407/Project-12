                    ...
                    <div className={s.footer__main_item}>
                        <p className={s.footer__main_item_text}>HTML</p>
                         <div className={s.footer__main_item_number}>
                            <p className={s.footer__main_item_color1}>45%</p>
                         </div>
                    </div>
                    <div className={s.footer__main_item}>
                        <p className={s.footer__main_item_text}>HTML</p>
                         <div className={s.footer__main_item_number}>
                            <p className={s.footer__main_item_color2}>45%</p>
                         </div>
                    </div>
                    <div className={s.footer__main_item}>
                        <p className={s.footer__main_item_text}>HTML</p>
                         <div className={s.footer__main_item_number}>
                            <p className={s.footer__main_item_color3}>45%</p>
                         </div>
                    </div>
                    <div className={s.footer__main_item}>
                        <p className={s.footer__main_item_text}>HTML</p>
                         <div className={s.footer__main_item_number}>
                            <p className={s.footer__main_item_color4}>45%</p>
                         </div>
                    </div>
                </div>
                    <div className={s.footer__main_item}>
                        <p className={s.footer__main_item_text}>HTML</p>
                         <div className={s.footer__main_item_number}>
                            <p className={s.footer__main_item_color5}>45%</p>
                         </div>
                    </div>
